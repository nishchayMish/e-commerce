...
import { attachGuestIdMiddleware } from "../../middlewares/optionalAuthMiddleware.js";
...
router.post("/login", sanitizedLoginInput, attachGuestIdMiddleware, loginController);
